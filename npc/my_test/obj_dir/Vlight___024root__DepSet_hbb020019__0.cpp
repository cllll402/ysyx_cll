...
VL_INLINE_OPT void Vlight___024root___nba_sequent__TOP__0(Vlight___024root* vlSelf) {
    ...
    // Body
    vlSelf->led = ((IData)(vlSelf->rst) ? 1U : ((0xfffeU 
                                                 & ((IData)(vlSelf->led) 
                                                    << 1U)) 
                                                | (1U 
                                                   & ((IData)(vlSelf->led) 
...
#endif
                    VL_FATAL_MT("/home/cll/ysyx/ysyx-workbench/npc/my_test/vsrc/light.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/cll/ysyx/ysyx-workbench/npc/my_test/vsrc/light.v", 1, "", "NBA region did not converge.");
            }
